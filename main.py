...
class func(object):
    ...
    def show_options(self, screen):
        ...
        option1 = font.render("继续游戏", True, (255, 255, 255))
        option2 = font.render("离开游戏", True, (255, 255, 255))
        option1_rect = screen.blit(option1, (50, 100))
        option2_rect = screen.blit(option2, (50, 150))
        print("option1_rect:", option1_rect)
        print("option2_rect:", option2_rect)
        print("生成rect了")

    def check_options_click(self, event):
...
def main():
    ...
    pygame.mixer.music.load("images/1.mp3")
                ...
                if clicked_dot:
                    ...
                    if chess_board.judge_attack_general(game.get_player()):
                        ...
                        if chess_board.judge_win(game.get_player()):
                            ...
                            game_func.show_options()
                            game_func.check_options_click(event)
                        else:
                            # 如果攻击到对方，则标记显示"将军"效果
                            game.set_attack()
                    # 落子之后，交换走棋方
